...
<!------------------ Message Template Update Modal---------------------->
<div class="modal fade bs-example-modal-lg" id="updateSmsTemplateModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content col-md-12">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.sms.template_update') }}" id="SmsTemplateForm" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-2">
                        <label>POP/Branch</label>
