...
<div class="row justify-content-center">
    <div class="col-lg-9">
        <div class="card">
            <form action="{{ route('admin.hr.employee.store') }}" method="POST" enctype="multipart/form-data" id="addEmployeeForm">
                @csrf
                <div class="card-body">
                    ...
                    <fieldset class="border p-4 shadow-sm rounded mb-4" style="border:2px #c9c9c9 dotted !important;">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="highest_education" class="form-control" placeholder="Enter Highest Education">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Previous School</label>
                                <input type="text" name="previous_school" class="form-control" placeholder="Enter Previous School">
                            </div>
                            <div class="col-md-6 mb-3">
                    ...
                    <fieldset class="border p-4 shadow-sm rounded mb-4" style="border:2px #c9c9c9 dotted !important;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="emergency_contact_phone" class="form-control"  placeholder="Enter Emergency Contact Phone">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label>Remarks</label>
                                <textarea name="remarks" class="form-control" rows="3" placeholder="Enter Remarks" style="height:38px;"></textarea>
                            </div>
                        </div>
                    </fieldset>
                    <!-- Salary Information -->
                    <fieldset class="border p-4 shadow-sm rounded mb-4" style="border:2px #c9c9c9 dotted !important;">
                        <legend class="w-auto px-3 text-primary fw-bold">Salary Information</legend>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="basic_salary">Basic Salary <span class="text-danger">*</span></label>
                                <input type="number" name="basic_salary" class="form-control" required step="0.01" min="0" placeholder="Enter Basic Salary">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="house_allowance">House Allowance <span class="text-danger">*</span></label>
                                <input type="number" name="house_allowance" class="form-control" required step="0.01" min="0" placeholder="Enter House Allowance">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="medical_allowance">Medical Allowance <span class="text-danger">*</span></label>
                                <input type="number" name="medical_allowance" class="form-control" required step="0.01" min="0" placeholder="Medical Allowance">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="other_allowance">Other Allowance <span class="text-danger">*</span></label>
                                <input type="number" name="other_allowance" class="form-control" required step="0.01" min="0" placeholder="Other Allowance">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tax">Tax <span class="text-danger">*</span></label>
                                <input type="number" name="tax" class="form-control" required step="0.01" min="0" placeholder="Tax">
                            </div>
                        </div>
                    </fieldset>
                </div>
