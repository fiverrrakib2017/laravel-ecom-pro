...
<div class="row justify-content-center">
    <div class="col-lg-9">
        <div class="card">
            <form action="{{ route('admin.hr.employee.loan.update') }}" method="POST" enctype="multipart/form-data" id="addEmployeeForm">
                @csrf
                    ...
                    <fieldset class="border p-4 shadow-sm rounded mb-4" style="border:2px #c9c9c9 dotted !important;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="loan_amount" class="form-control" placeholder="Enter Amount" value="{{ $data->loan_amount }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Installment Amount <span class="text-danger">*</span></label>
                                <input type="text" name="installment_amount" class="form-control" placeholder="Enter Installment Amount"  value="{{ $data->installment_amount }}"  required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Total Installment <span class="text-danger">*</span></label>
                                <input type="text" name="total_installments" class="form-control" placeholder="Enter Total Installment"  value="{{ $data->total_installments }}"  required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Paid Installments <span class="text-danger">*</span></label>
                                <input type="text" name="paid_installments" class="form-control" placeholder="Enter Paid Installment"  value="{{ $data->paid_installments }}"  required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Issu Date <span class="text-danger">*</span></label>
                                <input type="date" name="date_issued"  value="{{ $data->date_issued }}" class="form-control" required>
                            </div>
                        </div>
                    </fieldset>
