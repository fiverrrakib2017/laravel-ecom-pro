...
@section('title', 'Dashboard | Upcomming Expire Customer | Admin Panel')
@section('style')
@endsection
@section('content')
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <form class="row g-3 align-items-end" id="search_box">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="expire_days" class="form-label"> Expire Days <span
                                        class="text-danger">*</span></label>
                                <select name="expire_days" id="expire_days" class="form-select" style="width: 100%;"
                                    required>
    ...
    <!-- Modal for Bulk Recharge Comming Expire Customer-->
        ...
        function load_dropdown(url,target_url){
          ...
          $("button[name='search_btn']").click(function() {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    dataType: 'json',
                    data: {  _token: "{{ csrf_token() }}",pop_id: pop_id, area_id: area_id, expire_days: expire_days },
