...
<div class="row">
    <div class="container-fluid">
        <form id="form-data" action="{{ route('admin.client.invoice.update_invoice') }}" method="post">
            @csrf
            <input type="hidden" value="{{ $invoice_data->id }}" name="id">
            <div class="row">
                <div class="col-12">
                                ...
                                <div class="col-md-3 col-12 mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2 w-100">
                                        <select id="client_name" name="client_id" class="form-select select2 w-100" style="width: 100%;">
                                            ...
                                            @php $customers = \App\Models\Client::latest()->get(); @endphp
                                        ...
                                        <button type="button" class="btn btn-primary ml-2" data-bs-toggle="modal" data-bs-target="#CustomerModal">
