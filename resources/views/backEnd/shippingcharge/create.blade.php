        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h4 class="mb-0">Shipping Charge Create</h4>
                        <small class="text-muted">Shipping Charge Create easily</small>
                    </div>
                </div>
              ...
              <form action="{{route('shippingcharges.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Area Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" id="name" />
                            @error('name')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Amount" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ old('amount') }}" id="amount" />
                            @error('amount')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
