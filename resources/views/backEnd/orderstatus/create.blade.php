            ...
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Order Status Create easily</small>
                    </div>
                </div>
              ...
              <form action="{{route('orderstatus.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="Enter Name" class="form-control @error('name') is-invalid @enderror" name="name" id="name" required="">
                            @error('name')
