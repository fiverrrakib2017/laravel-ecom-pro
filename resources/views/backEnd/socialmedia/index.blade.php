            ...
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-3">
                   ...
                   <div class="bg-success text-white rounded-circle d-flex align-items-center justify-content-center"
                    ...
                    <div>
                        <h4 class="mb-0">Social Media Manage</h4>
                        <small class="text-muted">Manage social media easily</small>
                    </div>
                ...
                <div class="d-flex align-items-center gap-3 mt-2 mt-sm-0">
                    ...
                    <a href="{{ route('socialmedias.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-share-variant "></i> Social Media Create
                    </a>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <div class="d-flex justify-content-left gap-2">
                                        ...
                                        @if($value->status == 1)
                                            <form method="post"
                                                action="{{ route('socialmedias.inactive') }}"
                                                class="d-inline">
                                                @csrf
                                                <input type="hidden"
                                                    value="{{ $value->id }}"
                                        ...
                                        @else
                                            <form method="post"
                                                action="{{ route('socialmedias.active') }}"
                                                class="d-inline">
                                                @csrf
                                                <input type="hidden"
                                                    value="{{ $value->id }}"
