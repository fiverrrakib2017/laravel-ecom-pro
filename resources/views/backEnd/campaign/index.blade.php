            ...
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-3">
                   <div class="bg-success text-white rounded-circle d-flex align-items-center justify-content-center"
                    ...
                    <div>
                        ...
                        <small class="text-muted">Manage landing pages easily</small>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center gap-3 mt-2 mt-sm-0">
                    ...
                    <a href="{{ route('campaign.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-web"></i> Create Landing Page
                    </a>
                </div>
                            ...
                            <tr>
                                ...
                                <td >
                                    <div class="d-flex  gap-2">
                                        ...
                                        @if($value->status == 1)
                                            <form method="post"
                                                action="{{ route('campaign.inactive') }}"
                                                class="d-inline">
                                                @csrf
                                                <input type="hidden"
                                                    value="{{ $value->id }}"
                                        ...
                                        <form method="post" action="{{ route('campaign.destroy') }}" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                            @csrf
